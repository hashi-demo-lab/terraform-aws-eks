...
module "fargate_profile" {
  source = "git::https://github.com/hashi-demo-lab/terraform-aws-eks/terraform-aws-eks.git//fargate-profile"
...
module "eks_managed_node_group" {
  source = "git::https://github.com/hashi-demo-lab/terraform-aws-eks/terraform-aws-eks.git//eks-managed-node-group"
...
module "self_managed_node_group" {
  source = "git::https://github.com/hashi-demo-lab/terraform-aws-eks/terraform-aws-eks.git//self-managed-node-group"
