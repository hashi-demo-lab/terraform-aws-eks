...
module "fargate_profile" {
  source = "git::https://github.com/hashi-demo-lab/terraform-aws-eks.git//modules/fargate-profile"
...
module "eks_managed_node_group" {
  source = "git::https://github.com/hashi-demo-lab/terraform-aws-eks.git//modules/eks-managed-node-group"
...
module "self_managed_node_group" {
  source = "git::https://github.com/hashi-demo-lab/terraform-aws-eks.git//modules/self-managed-node-group"
